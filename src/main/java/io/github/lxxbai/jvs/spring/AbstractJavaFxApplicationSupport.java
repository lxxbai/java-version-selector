...
public abstract class AbstractJavaFxApplicationSupport extends Application {
     ...
     * 加载非懒加载的view
     */
    private void loadNoLazyView() {
        //加载非懒加载的view
        applicationContext.getBeansOfType(AbstractFxmlView.class).values().stream()
                .filter(view -> !view.getAnnotation().lazy())
                .forEach(AbstractFxmlView::getView);
    }
