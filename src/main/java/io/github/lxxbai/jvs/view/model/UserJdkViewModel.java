...
import io.github.lxxbai.jvs.service.UserJdkVersionService;
...
public class UserJdkViewModel {
     ...
     * 保存数据
     */
    public void save(List<JdkInfoVO> selectedList) {
        userJdkVersionService.saveUserJdk(selectedList);
        refresh();
    }
     ...
     * 删除
     *
     * @param userJdkVersion jdk
     */
    public void deleteRecord(UserJdkVersionVO userJdkVersion) {
        userJdkVersionService.deleteRecord(userJdkVersion);
        // 刷新
        refresh();
    }
