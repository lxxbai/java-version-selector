...
import io.github.lxxbai.jvs.event.InstallEndEvent;
import io.github.lxxbai.jvs.event.InstallStatusEvent;
import io.github.lxxbai.jvs.model.InstallRecordVO;
import io.github.lxxbai.jvs.model.JdkVersionVO;
import io.github.lxxbai.jvs.service.InstallService;
 ...
 */
@Component
public class NewInstallViewModel {
     ...
     * @return 下载进度条
     */
    private XxbDownloadBar buildDownloadProgressBar(InstallRecordVO installRecordVO) {
        //获取下载地址
        XxbDownloadBar xxbDownloadBar = new XxbDownloadBar(150, 2,
                installRecordVO.getDownloadUrl(), installRecordVO.getJdkPackageUrl());
        //失败
        xxbDownloadBar.setOnFailed(event -> {
            JFXMsgAlertUtil.showError(GUIState.getStage(), "失败", "下载失败！");
