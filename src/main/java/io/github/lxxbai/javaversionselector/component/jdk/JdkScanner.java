package io.github.lxxbai.javaversionselector.component.jdk;

import io.github.lxxbai.javaversionselector.common.exception.ClientException;
import io.github.lxxbai.javaversionselector.common.util.JdkUtil;
...
public class JdkScanner {
     ...
     */
    private boolean isJdk(File dir) {
        // 检查是否存在 bin 和 lib 目录
